...
const Splash_Screen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <Icon style={styles.icon} name="screen-rotation" size={150} color="white" /> */}
      <Image
        style={styles.image}
        source={require('../../assets/images/front-camera.png')}
      />
      <Text style={styles.txt_title}>Front Camera</Text>
      <Text style={styles.txt_tutor}>
        Keep the front-facing camera pointed at yourself until the test is
        complete
      </Text>
