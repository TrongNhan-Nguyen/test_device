...
const Splash_Screen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Icon style={styles.icon} name="microphone" size={150} color="white" />
      <Text style={styles.txt_title}>Microphone</Text>
      <Text style={styles.txt_tutor}>
        Just press begin to start the test. Attention! this test involves HIGH
        frequencies sounds!
      </Text>
