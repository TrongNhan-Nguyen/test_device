...
const Splash_Screen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Icon style={styles.icon} name="volume-up" size={150} color="white" />
      <Text style={styles.txt_title}>Speakers</Text>
      <Text style={styles.txt_tutor}>
        Listen to the 3 numbers you hear through the speaker and enter them on
